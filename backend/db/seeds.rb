...
responsibility_a = Responsibility.create(partner_id: "4", task: "Produce Content")
...
responsibility_e = Responsibility.create(partner_id: "5", task: "Finalize Trust Formations")
responsibility_f = Responsibility.create(partner_id: "6", task: "Put Together Code of Coduct Agreement")
